...
def simulate(mass):
    ...
    def update():
        ...
        text22 = font.render("Velocity: " + str(round(2500 * block2.velocity, 5)) + " m/s", True, colourH)
        text222 = font.render("Mass: " + str(round(block2.mass)) + " kg", True, colourH)
        text3 = font.render("Left block:", True, colourH)
        text33 = font.render("Velocity: " + str(round(2500 * block1.velocity, 5)) + " m/s", True, colourH)
        text333 = font.render("Mass: " + str(round(block1.mass)) + " kg", True, colourH)
        screen.fill(colourL)
